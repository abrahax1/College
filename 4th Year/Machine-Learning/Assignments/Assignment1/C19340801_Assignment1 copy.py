...
features = open('Machine Learning/Assignment1/data/feature_names.txt')
...
data = pd.read_csv('Machine Learning/Assignment1/data/dataset.csv', na_values=' ?', names=features)
...
continuous_table.to_csv('Machine Learning/Assignment1/data/C19340801CONT.csv', index=False)

categorical_table = pd.DataFrame(categorical_table)
categorical_table.to_csv('Machine Learning/Assignment1/data/C19340801CAT.csv', index=False)
