...
#
# --------------------------------------------------------------------
# k-NN Prices Modelling Approach 
# finds a few of the most similar items and assumes the prices
...
## 28.56386131112269
#
# During the lecture we talked about other direct similarity metrics such
# as the Manhattan distance and Cosine.
#
# -----------------
# Task:
# Next you will have implement functions to compute these
...
## 37.610888778473793
## >>> wineprice(99.0,5.0) # Get the actual price
## 30.306122448979593
## >>> knnestimate(data,(99.0,5.0),k=1) # Try with fewer neighbors
## 38.078819347238685
#
...
# (1) the result of this subtraction if the result is greater than zero;
...
# (2) summing the results of thezse multiplicationsbefore adding them together.
